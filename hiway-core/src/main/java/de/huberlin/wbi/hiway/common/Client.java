...
public class Client {
	...
	public boolean run() throws IOException, YarnException {
		...
		Data appMasterJar = new Data(appMasterJarPath);
		appMasterJar.stageOut(fs, "");
		appMasterJar.addToLocalResourceMap(localResources, fs, "");
		...
		if (workflowType.equals(Constant.WorkflowFormat.dax)) {
			vargs.add("de.huberlin.hiway.app.DaxApplicationMaster");
		} else {
			vargs.add("de.huberlin.hiway.app.CuneiformApplicationMaster");
		}
